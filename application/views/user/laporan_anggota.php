...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php }?>
            <?= $this->session->flashdata('pesan'); ?>
            <a href="<?= base_url('laporan/cetak_laporan_anggota');?>" target="_blank" class="btn btn-primary mb-3"><i class="fas fa-print"></i> </a>
            <a href="<?= base_url('laporan/laporan_anggota_pdf'); ?>" target="_blank" class="btn btn-warning mb-3"><i class="far fa-file-pdf"></i> </a>
            <a href="<?= base_url('laporan/export_excel_anggota'); ?>" target="_blank" class="btn btn-success mb-3"><i class="far fa-file-excel"></i> </a>
